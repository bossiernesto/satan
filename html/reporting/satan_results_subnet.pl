...
<H4> Sort hosts by:
<A HREF="satan_results_subnet.pl,$_subnet,name.html">name</a> |
<A HREF="satan_results_subnet.pl,$_subnet,domain.html">domain</a> |
<A HREF="satan_results_subnet.pl,$_subnet,type.html">system type</a> |
<A HREF="satan_results_subnet.pl,$_subnet,severity.html">problem count</a> |
<A HREF="satan_results_subnet.pl,$_subnet,severity_type.html">problem type</a>
</H4>
EOF
